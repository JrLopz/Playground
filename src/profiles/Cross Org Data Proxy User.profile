...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>AgendaClass</application>
    ...
    <classAccesses>
        <apexClass>Agenda</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>AgendaControl</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        ...
        <field>Alumno__c.Edad__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Alumno__c.Grado__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Alumno__c.Grupo__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Maestro__c.Jefe_de_area__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Threat_Tier__mdt.Account_their__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>VAT_Data__mdt.Country__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <layoutAssignments>
        <layout>Alumno__c-Formato Alumno</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Asistencia__c-Formato Asistencia</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Clase__c-Formato Clase</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Maestro__c-Formato Maestro</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>vacation_packages__c-vacation packages Layout</layout>
    </layoutAssignments>
    <pageAccesses>
        <apexPage>AgendaClass</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
